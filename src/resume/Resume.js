    ...
    return (
      <div class="outer">
        ...
        <div class="inner one">
          <div class="r-header">
            <h4>Resume</h4>
            <a href="document/resume.pdf" target="_blank" name="site-link" class="site-link r-link"></a>
          </div>
          <h5>Education</h5>
          <div>
            <a href="https://www.waketech.edu/" rel="noreferrer" target="_blank">
              <img class="logo" id="wake" src={waketech} height="50px" width="50px" alt="waketech" />
            </a>
            <p>
          ...
          <p class="c-lst">Related Coursework</p>
          <ul class="lst">
            <li>Computing Fundamentals</li>
            <a href="https://www.oracle.com/java/" target="_blank" rel="noreferrer" class="code">
              Java
            </a>
            <li>Web, Pgm, Db Foundation</li>
            <li>Operating Systems Concepts</li>
            <a href="https://www.python.org/" rel="noreferrer" target="_blank" class="code">
              Python
            </a>
            <li>Network and Security Foundation</li>
            <li>Database Programming</li>
            <a href="https://www.javascript.com/" rel="noreferrer" target="_blank" class="code">
              JavaScript
            </a>
            <li>Web Markup and Scripting</li>
            <li>Software Quality Assurance</li>
            <a href="https://en.wikipedia.org/wiki/SQL" rel="noreferrer" target="_blank" class="code">
              SQL
            </a>
            <li>Software Development</li>
            <li>Advanced Python & Java Programming</li>
            <a href="https://www.w3.org/standards/webdesign/htmlcss.html" rel="noreferrer" target="_blank" class="code">
              HTML & CSS
            </a>
          </ul>
          <h5>Experience</h5>
          <div>
            <a href="https://bitly.com/" rel="noreferrer" target="_blank">
              <img class="logo" src={bitly} height="50px" width="50px" alt="bitly" />
            </a>
            <p>
              <b>Bitly</b>
          ...
          <ul class="experience">
            ...
            <a href="https://golang.org/" target="_blank" rel="noreferrer" class="code">
              Go
            </a>
            ...
            <a href="https://www.python.org/" target="_blank"  rel="noreferrer" class="code">
              Python
            </a>
