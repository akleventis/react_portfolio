        ...
        return (
            ...
            <a id="projects"></a>  
              <div className="inner two">
                <h4>Projects</h4>
                <div className="row">
                  <div data-aos="zoom-in" data-aos-duration="1500" className="box">
                    <a href="https://github.com/akleventis/Cat-Dog-Service" target="_blank" style={{backgroundImage: `url(${git})`}} className="git"></a>
                    <img src={dog} alt="dog" />
                    <p className="text">
                  ...
                  <div data-aos="zoom-in" data-aos-duration="1500" className="box">
                    <a href="https://alexcod.es/reactapi-github" target="_blank" style={{backgroundImage: `url(${git})`}} className="git"></a>
                    <img src={cat} alt="cat" />
                    <a href="https://alexcod.es/reactapi" target="_blank" style={{backgroundImage: `url(${site})`}} name="site-link" className="site-link"></a>
                    <p className="text">
                ...
                <p className="more">- more side projects @ <a className="in-link" href="http://alexcod.es/github" target="_blank">alexcod.es/github </a>-</p>
                </div>
